...
<style>
  .section-convertion-and-format .flex-wrap .content-p{
          ...
          <div class="flex-50">
            <div class="flex-inner">              
              <div>
                  ...
                  <p class="content-p">
                    Easily convert your JPEG files into JPG files using this online converter. By using CloudConvert, you will have the ability to convert any of your picture documents on the web. We support a wide range of file types, including PNG, JPG, GIF, WEBP, and HEIC, among many other formats.
                  <p>
                </div>
          ...
          <div class="flex-50">
            <div class="flex-inner">              
              ...
              <h3 class="heading-md">PNG</h3>
                <p class="content-p">
                  PNG means "Versatile Illustration Configuration". Uncompressed raster pictures are most often used on the web. Designed to replace Illustrations Exchange Format (GIF). The PNG file format has no copyright restrictions. In addition to GIF images, PNGs show simple foundations.
                <p>
              </div>
            ...
            <div class="flex-inner">              
              <div>
                <h3 class="heading-md">WEBP</h3>
                  <p class="content-p">
                    The WEBG file format is a raster graphics file format developed by Google, which is intended to replace the JPEG, PNG, and GIF formats for raster graphics files. Aside from supporting both lossy and lossless compression, it also supports animations and alpha transparent images.
                  <p>
              </div>
            ...
            <div class="flex-inner">              
              <div>
                <h3 class="heading-md">GIF</h3>
                  <p class="content-p">
                    GIF stands for Graphics Interchange Format. The GIF format is a format for storing bitmap images. Typically, GIF images are compressed using a lossless compression method called Lempel-Ziv-Welch (LZW) in order to reduce the file size without degrading the quality of the images.
                  <p>
              </div>
                  <img src="{{asset('./assets/images/speed.svg')}}" alt="Online Compress Size of Image">
              </div>
